...
\ifthenelse{\equal{#1}{NB}}{
    \draw[-{To[length=4, width=5]}, line width=0.3mm]  (#2 + 0.21 + 0.08 , #3 - 0.21 + 0.08) -- (#4 - 0.21,#5 + 0.21);
    \draw[{To[length=4, width=5]}-, line width=0.3mm]  (#2 + 0.21 - 0.01, #3 - 0.22) -- (#4 - 0.21 - 0.08,#5 + 0.1);
}{
