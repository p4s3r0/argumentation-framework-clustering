...
Now we can compute the sets of the according semantic (cf, adm, stb). To reduce cluttering, we keep this example to the stable semantic. The stable sets of the AF $G$ are \texttt{stb=\{\{d, e\}, \{b, d, f\}\}}.
