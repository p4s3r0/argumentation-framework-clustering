...
\begin{minipage}{.5\textwidth}
    ...
    \begin{tikzpicture}
        ...
        % Attacks
        \DrawSelfAttackLeftTopCluster{\hx-0.4}{\hy+0.29}
        \DrawAttackVertical{D}{\hx}{\hy}{\cx}{\cy}
        \DrawAttackHorizontal{B}{\dx}{\dy}{\cx}{\cy}
        \DrawAttackHorizontal{B}{\ex}{\ey}{\hx+0.25}{\hy}
...
When taking a look at the conflict-free sets of the concrete AF $G$ (e.g.\ $\bigl\{ \{\},$ $\{b\},$ $\{c\},$ $\{d\},$ $\{e\},$ $\{b, d\},$  $\{c, e\},$ $\{d, e\} \bigl\}$) and the abstractly conflict-free sets of the abstract AF $\hat{G}$ (e.g.\ $\bigl\{ \{\},$ $\{c\},$ $\{d\},$ $\{e\},$ $\{\hat{h}\},$ $\{c, e\},$ $\{c, \hat{h}\},$ $\{d, e\},$ $\{d, \hat{h}\},$ $\{e, \hat{h}\},$ $\{c, e, \hat{h}\},$ $\{e, d, \hat{h}\} \bigl\}$) we can observe, that the abstract AF $\hat{G}$ is spurious due to the sets $\bigl\{\{\hat{h}, d, e\},$ $\{\hat{h}, e\},$ $\{c, \hat{h}, e\},$ $\{c, \hat{h}\}\bigl\}$. Now we compute the concretizer list and obtain the sets defined in \cref{table:computeFaithfulClusterConcretizerTable}.
...
\begin{table}[htb]
    ...
    \begin{tabular}{ |c|c|c|c|c| }
        ...
        \hline
    \end{tabular}
\caption{Concretizer list}
\label{table:computeFaithfulClusterConcretizerTable}
\end{table}

For this example, we can concretize six sets of the concretizer list to obtain a faithful AF $\hat{G}'$, e.g.\ $\bigl\{ \{a, b\},$ $\{a, b, e\},$ $\{a, b, c, d\},$ $\{b, c, d, e\},$ $\{a, b, c, e\},$ $\{a, b, c, d, e\}\bigl\}$. Each of them depicted in \cref{af:computeFaithfulClusterSolutions}.
