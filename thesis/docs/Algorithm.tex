...
\paragraph{Admissible} Every satisfiable model of \cref{def:booleanFormulaAdmissible} is an admissible set.

\begin{definition}
    Let $G=(A,R)$ be an AF. Then all the satisfiable of the following formula are admissible sets.
    \begin{center}
