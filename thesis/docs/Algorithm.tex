...
\begin{definition}
    Let $G=(A,R)$ be an AF. Then all the satisfiable of the following formula are conflict-free sets.
    \begin{center}
        \[
...
\begin{example}
    Let us have a look at an example and define the AF $G=(A,R)$ to be the AF depicted in \cref{af:algorithmEncodings}. Where the arguments are $A=\{a, b, c, d\}$ and the attacks $R=\big\{ (a,a), (a,b), (b,c), (d,a), (d,b), (d,c)\big\}$.
    ...
    \begin{figure}[H]
        ...
        \label{af:algorithmEncodings}
    \end{figure}
\end{example}

The generated Boolean expression for this example is the following.
\begin{align*}
    \psi =
    \lnot(\land(2, 1))  \land
    \lnot(\land(2, 4))  \land
