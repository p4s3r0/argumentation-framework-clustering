...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \def \cbIX{0}
        \def \cbIY{1.5cm}
        \node[rectangle, draw, line width=0.3mm, minimum width=\bwidth, minimum height=\bheight , text width=\bwidth, align=center] at (\cbIX, \cbIY) {Compute abstract extensions};
        ...
        \def \cbIIX{0}
        \def \cbIIY{-1.5cm}
        \node[rectangle, draw, line width=0.3mm, minimum width=\bwidth, minimum height=\bheight , text width=\bwidth, align=center] at (\cbIIX, \cbIIY) {Compute abstract extensions};
